...
const COPY: Record<"ja" | "en", Copy> = {
  ja: {
    ...
    outcomes: [
      ...
      { num: "04", who: "会社に残る", title: "助成金の計画届・支給申請に必要な添付資料", body: "カリキュラム・訓練実施記録・出席記録など、訓練実施機関として当社が発行する添付資料と、様式のひな形・記入例をお渡しします。計画届・支給申請書のご提出は貴社にて行っていただき、書類作成の代行が必要な場合は提携の社会保険労務士をご紹介します。最終的な支給可否は労働局の審査によります。" },
    ...
    faq: [
      ...
      { q: "事業展開等リスキリング支援コースが終了する2027年4月以降はどうなりますか？", a: "同コースは令和8年度末（2027年3月）までの時限措置で、後継の制度は現時点で公表されていません。人材育成支援コースなど他のコースや、都道府県の人材育成補助金（例: 茨城県の中小企業人材育成支援事業補助金）の対象になり得る設計でご提案します。最新情報は無料相談でご案内します。" },
