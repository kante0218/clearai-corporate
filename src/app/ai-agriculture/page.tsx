  ...
  return (
    <>
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-white">
        <div className="absolute bottom-1/3 right-1/4 w-[1px] h-[1px] shadow-[0_0_300px_150px_rgba(16,185,129,0.06)]" />
        <div className="relative z-10 w-full max-w-6xl mx-auto px-6 lg:px-10 py-20 lg:py-0">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            {/* Copy — left column */}
            <div>
              <span
                className="inline-block rounded-full bg-emerald-50 text-emerald-600 px-3 py-1 text-sm font-semibold mb-6 transition-all duration-700"
            ...
            >
              <AgricultureScene className="w-full max-w-[520px] drop-shadow-sm" />
            </div>
            {/* Mobile illustration */}
            <div
            ...
            >
              <AgricultureScene className="w-full max-w-[340px] mx-auto drop-shadow-sm" />
            </div>
          </div>
        </div>
      </section>
