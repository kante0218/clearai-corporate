    ...
    lineupGroups: [
      {
        ...
        robots: [
          ...
          { name: "Unitree B2", type: "産業用四足歩行ロボット", desc: "高い積載・走破性を重視した産業向け四足歩行型。巡回・点検・屋外実証に。", image: "/images/robot-rental/b2.webp" },
      ...
      },
      {
        ...
        robots: [
          { name: "Spot", type: "四足歩行ロボット", desc: "施設巡回・点検・遠隔監視に強い商用四足歩行型。産業現場の自動巡回PoC向け。", image: "/images/robot-rental/spot.webp" },
          { name: "Spot Arm", type: "モバイルマニピュレーション", desc: "Spot にアームを組み合わせた構成。扉・バルブ・軽作業など操作系デモの候補。", image: "/images/robot-rental/spot-arm.avif" },
          { name: "Stretch", type: "物流ロボット", desc: "倉庫でのケース荷役・トラック荷下ろし向け。物流自動化の実証候補。", image: "/images/robot-rental/stretch.webp" },
      ...
      },
      {
        ...
        robots: [
          ...
          { name: "AgiBot A2 Lite", type: "ヒューマノイド", desc: "パフォーマンス・展示・商業施設での演出用途を想定した候補機。", image: "/images/robot-rental/agibot-a2-lite.webp" },
          ...
          { name: "AgiBot D1", type: "四足歩行ロボット", desc: "D1 Pro / Edu / Ultra / Max 系を含む四足歩行型。巡回・教育・産業点検の候補。", image: "/images/robot-rental/agibot-d1.webp" },
    ...
    lineupGroups: [
      {
        ...
        robots: [
          ...
          { name: "Unitree B2", type: "Industrial quadruped", desc: "An industrial quadruped candidate focused on payload, terrain handling, patrol, and inspection use cases.", image: "/images/robot-rental/b2.webp" },
      ...
      },
      {
        ...
        robots: [
          { name: "Spot", type: "Quadruped", desc: "A commercial quadruped for facility patrol, inspection, and remote monitoring PoCs.", image: "/images/robot-rental/spot.webp" },
          { name: "Spot Arm", type: "Mobile manipulation", desc: "A Spot configuration with an integrated arm for doors, valves, and light manipulation demos.", image: "/images/robot-rental/spot-arm.avif" },
          { name: "Stretch", type: "Warehouse robot", desc: "A logistics robot for case handling and trailer unloading in warehouse automation trials.", image: "/images/robot-rental/stretch.webp" },
      ...
      },
      {
        ...
        robots: [
          ...
          { name: "AgiBot A2 Lite", type: "Humanoid", desc: "A candidate for performances, exhibitions, and commercial presentation settings.", image: "/images/robot-rental/agibot-a2-lite.webp" },
          ...
          { name: "AgiBot D1", type: "Quadruped", desc: "A quadruped family candidate for patrol, education, and industrial inspection trials.", image: "/images/robot-rental/agibot-d1.webp" },
