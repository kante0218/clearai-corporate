    ...
    lineupGroups: [
      {
        ...
        robots: [
          ...
          { name: "Unitree B2", type: "産業用四足歩行ロボット", desc: "高い積載・走破性を重視した産業向け四足歩行型。巡回・点検・屋外実証に。", image: "/images/robot-rental/b2.jpg" },
          { name: "Unitree A2", type: "産業用四足歩行ロボット", desc: "長時間稼働と拡張性を重視した四足歩行型。物流・工場・災害対応PoCに。", image: "/images/robot-rental/a2.jpg" },
          { name: "Unitree As2", type: "小型産業用四足歩行ロボット", desc: "Go2より産業用途に寄せた小型機。持ち運びや短期デモをしやすい候補機。", image: "/images/robot-rental/as2.jpg" },
        ],
      },
      {
        ...
        robots: [
          { name: "Spot", type: "四足歩行ロボット", desc: "施設巡回・点検・遠隔監視に強い商用四足歩行型。産業現場の自動巡回PoC向け。", image: "/images/robot-rental/spot.jpg" },
          { name: "Spot Arm", type: "モバイルマニピュレーション", desc: "Spot にアームを組み合わせた構成。扉・バルブ・軽作業など操作系デモの候補。", image: "/images/robot-rental/spot-arm.jpg" },
          { name: "Stretch", type: "物流ロボット", desc: "倉庫でのケース荷役・トラック荷下ろし向け。物流自動化の実証候補。", image: "/images/robot-rental/stretch.jpg" },
          { name: "Atlas", type: "産業用ヒューマノイド", desc: "製造・マテリアルハンドリング領域を見据えた次世代ヒューマノイド候補。", image: "/images/robot-rental/atlas.jpg" },
        ],
      },
      {
        company: "AgiBot",
        ...
        robots: [
          { name: "AgiBot A2", type: "フルサイズヒューマノイド", desc: "商用実証・接客・展示・作業デモ向けのフルサイズ人型ロボット候補。", price: "¥100,000", priceUnit: "/ 日（税込）", buyUrl: PAY.agibot, status: "booking", image: "/images/robot-rental/agibot-a2.png" },
          { name: "AgiBot A2-W", type: "車輪型ヒューマノイド", desc: "移動安定性と上半身作業を組み合わせた車輪型。施設案内・軽作業実証の候補。", image: "/images/robot-rental/agibot-a2w.png" },
          { name: "AgiBot A2 Lite", type: "ヒューマノイド", desc: "パフォーマンス・展示・商業施設での演出用途を想定した候補機。", image: "/images/robot-rental/agibot-a2lite.png" },
          { name: "AgiBot X1", type: "オープンソースロボット", desc: "研究開発・教育・ソフトウェア検証に使いやすいフルスタック開発向け候補。", image: "/images/robot-rental/agibot-x1.webp" },
          ...
          { name: "AgiBot G2", type: "汎用 embodied AI ロボット", desc: "産業グレードの embodied AI ロボット。作業自動化PoCの候補。", image: "/images/robot-rental/agibot-g2.webp" },
      ...
      },
      {
        ...
        robots: [
          { name: "JAKA Zu Series", type: "協働ロボットアーム", desc: "3kgから30kg級まで展開する汎用協働ロボット。搬送・組立・検査・梱包PoCに。", image: "/images/robot-rental/jaka-zu.jpg" },
          { name: "JAKA S Series", type: "力制御協働ロボット", desc: "高精度な力覚制御を重視したシリーズ。研磨・嵌合・繊細な組立の候補。", image: "/images/robot-rental/jaka-zu.jpg" },
          { name: "JAKA Pro Series", type: "高耐環境協働ロボット", desc: "油・粉じん・水に強いIP68系。金属加工・食品・屋外に近い現場の実証向け。", image: "/images/robot-rental/jaka-pro.jpg" },
      ...
      },
      {
        ...
        robots: [
          { name: "PUDU D7", type: "半ヒューマノイド", desc: "産業・サービス現場向けの半ヒューマノイド。搬送・案内・施設内作業の候補。", image: "/images/robot-rental/pudu-d7.webp" },
        ],
      },
    ],
    ...
    lineupGroups: [
      {
        ...
        robots: [
          ...
          { name: "Unitree B2", type: "Industrial quadruped", desc: "An industrial quadruped candidate focused on payload, terrain handling, patrol, and inspection use cases.", image: "/images/robot-rental/b2.jpg" },
          { name: "Unitree A2", type: "Industrial quadruped", desc: "A long-runtime, extensible quadruped candidate for logistics, factory, and emergency-response PoCs.", image: "/images/robot-rental/a2.jpg" },
          { name: "Unitree As2", type: "Compact industrial quadruped", desc: "A compact industrial candidate positioned above Go2 for portable demonstrations and field trials.", image: "/images/robot-rental/as2.jpg" },
        ],
      },
      {
        company: "Boston Dynamics",
        ...
        robots: [
          { name: "Spot", type: "Quadruped", desc: "A commercial quadruped for facility patrol, inspection, and remote monitoring PoCs.", image: "/images/robot-rental/spot.jpg" },
          { name: "Spot Arm", type: "Mobile manipulation", desc: "A Spot configuration with an integrated arm for doors, valves, and light manipulation demos.", image: "/images/robot-rental/spot-arm.jpg" },
          { name: "Stretch", type: "Warehouse robot", desc: "A logistics robot for case handling and trailer unloading in warehouse automation trials.", image: "/images/robot-rental/stretch.jpg" },
          { name: "Atlas", type: "Industrial humanoid", desc: "A next-generation humanoid candidate for manufacturing and material handling workflows.", image: "/images/robot-rental/atlas.jpg" },
        ],
      },
      {
        company: "AgiBot",
        ...
        robots: [
          { name: "AgiBot A2", type: "Full-size humanoid", desc: "A full-size humanoid candidate for commercial PoCs, hospitality, exhibitions, and task demos.", price: "JPY 100,000", priceUnit: "/ day (tax incl.)", buyUrl: PAY.agibot, status: "booking", image: "/images/robot-rental/agibot-a2.png" },
          ...
          { name: "AgiBot A2 Lite", type: "Humanoid", desc: "A candidate for performances, exhibitions, and commercial presentation settings.", image: "/images/robot-rental/agibot-a2lite.png" },
          { name: "AgiBot X1", type: "Open-source robot", desc: "A full-stack development candidate for R&D, education, and software validation.", image: "/images/robot-rental/agibot-x1.webp" },
          ...
          { name: "AgiBot G2", type: "General embodied AI robot", desc: "An industrial-grade embodied AI robot candidate for task automation PoCs.", image: "/images/robot-rental/agibot-g2.webp" },
      ...
      },
      {
        ...
        robots: [
          { name: "JAKA Zu Series", type: "Collaborative robot arm", desc: "A general cobot range from 3kg to 30kg classes for handling, assembly, inspection, and packing PoCs.", image: "/images/robot-rental/jaka-zu.jpg" },
          { name: "JAKA S Series", type: "Force-control cobot", desc: "A force-control series candidate for polishing, fitting, and delicate assembly tasks.", image: "/images/robot-rental/jaka-zu.jpg" },
          { name: "JAKA Pro Series", type: "Rugged cobot", desc: "An IP68-oriented rugged series for demanding sites such as metalworking, food, and harsher environments.", image: "/images/robot-rental/jaka-pro.jpg" },
      ...
      },
      {
        ...
        robots: [
          { name: "PUDU D7", type: "Semi-humanoid", desc: "A semi-humanoid candidate for industrial and service environments, including indoor operations and guidance.", image: "/images/robot-rental/pudu-d7.webp" },
        ],
      },
    ],
