    ...
    <>
      ...
      <section className="bg-white pt-32 lg:pt-40 pb-16 lg:pb-24">
        <div className="max-w-[1800px] mx-auto px-6 lg:px-8">
          ...
          <h1 className="mt-10 text-[10vw] sm:text-5xl lg:text-7xl font-bold leading-[0.95] tracking-[-0.04em] text-balance text-neutral-900 transition-[opacity,transform] duration-700" style={{ opacity: heroLoaded ? 1 : 0, transform: heroLoaded ? "translateY(0)" : "translateY(24px)", transitionDelay: "500ms" }}>
            {t.heroTitle}
          </h1>
