...
const COPY: Record<"ja" | "en", Copy> = {
  ja: {
    ...
    companyInfo: [
      ...
      { label: "所在地", value: "茨城県" },
      { label: "事業内容", value: "AI受託開発 / AI内製化研修 / FDEコンサル・AI顧問 / ロボットレンタル" },
      { label: "資本金", value: "非公開" },
  ...
  en: {
    ...
    companyInfo: [
      ...
      { label: "Business", value: "AI software development / AI enablement training / FDE consulting & AI advisory / Robot rental" },
