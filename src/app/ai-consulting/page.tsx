        ...
        <div className="max-w-[1800px] mx-auto px-6 lg:px-8">
          <Reveal>
            ...
            <div className="mt-12 grid grid-cols-1 items-end gap-10 lg:grid-cols-12">
              <div className="lg:col-span-8">
                <h2 className="text-[20px] sm:text-2xl lg:text-3xl font-bold leading-[1.15] sm:leading-[1.05] tracking-[-0.02em] text-balance whitespace-pre-line text-white">{t.ctaTitle}</h2>
