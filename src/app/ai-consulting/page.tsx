...
function SectionHead({
  ...
  return (
    <Reveal className="mb-12 lg:mb-16 max-w-3xl">
      ...
      <h2 className={`mt-8 text-[22px] sm:text-3xl lg:text-4xl font-bold leading-[1.15] sm:leading-[1.05] tracking-[-0.02em] text-balance whitespace-pre-line ${dark ? "text-white" : "text-neutral-900"}`}>
        {title}
      </h2>
        ...
        <div className="max-w-[1800px] mx-auto px-6 lg:px-8">
          <Reveal>
            ...
            <div className="mt-12 grid grid-cols-1 items-end gap-10 lg:grid-cols-12">
              <div className="lg:col-span-8">
                <h2 className="text-[22px] sm:text-3xl lg:text-4xl font-bold leading-[1.15] sm:leading-[1.05] tracking-[-0.02em] text-balance whitespace-pre-line text-white">{t.ctaTitle}</h2>
