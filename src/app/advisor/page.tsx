          ...
          <div className="border border-neutral-900 bg-white">
            <div className="grid lg:grid-cols-2">
              <Reveal className="border-b border-neutral-900 p-8 lg:p-12 lg:border-b-0 lg:border-r">
                ...
                <h2 className="mt-8 text-[22px] sm:text-2xl lg:text-3xl font-bold leading-[1.15] sm:leading-[1.05] tracking-[-0.02em] text-balance text-neutral-900">{t.claudeTitle}</h2>
