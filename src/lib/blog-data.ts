...
すでに多くの企業がAI面接を導入し、採用効率の向上と候補者体験の改善を実感しています。clearAIの「導（みちびき）」は、日本市場に特化したAI面接プラットフォームとして、200社以上の企業に導入されています。`,
    category: "AI活用",
    date: "2026-03-15",
    readTime: "5分",
    author: "clearAI編集部",
...
成果が確認できたら、段階的に適用範囲を拡大していきます。`,
  ...
  },
  {
    ...
    excerpt: "従来の採用プロセスに課題を抱えていたテックフォワード社が、clearAIのソリューション導入で劇的な改善を達成した事例をご紹介。",
...
clearAIでは、これらの活用シーンに応じたAI導入支援を提供しています。`,
    category: "テクノロジー",
    date: "2026-02-28",
    readTime: "7分",
    author: "clearAI編集部",
  ...
  },
  {
    ...
    title: "clearAI、シリーズA資金調達を完了 ― AI面接と企業AI導入の二軸で事業拡大へ",
    excerpt: "clearAI株式会社は、AI面接プラットフォーム「導」と企業向けAI導入支援の二軸で事業拡大を加速します。",
    content: `clearAI株式会社は、事業拡大に向けた新たなフェーズに入りました。
