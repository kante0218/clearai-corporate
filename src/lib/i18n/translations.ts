...
export const home = {
  ja: {
    ...
    heroDescLine2:
      "コンサル・顧問・研修・Claude Code導入・補助金活用・農業自動化の6領域で、現場で動くものまで責任を持ちます。",
    contact: "お問い合わせ",
    viewServices: "事業を見る →",
    trustStats: [
  ...
  en: {
    ...
    heroDescLine2:
      "Consulting, advisory, training, Claude Code, subsidy programs, and agricultural automation. Six focus areas, all the way to working systems.",
    contact: "Contact Us",
    viewServices: "View services →",
    trustStats: [
      { value: "Up to 75%", label: "Training subsidy supported" },
      { value: "6 areas", label: "AI × Agriculture" },
